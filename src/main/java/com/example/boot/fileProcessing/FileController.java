...
public class FileController {
	 ...
	 * download(@PathVariable("fileName")String fileName) throws IOException{ byte[]
	 * fileData=Files.readAllBytes(new File(UPLOAD_DIR+fileName).toPath());
	 * HttpHeaders httpHeaders = new HttpHeaders();
	 * httpHeaders.setContentType(MediaType.IMAGE_JPEG); return new
	 * ResponseEntity<byte[]>(fileData,httpHeaders,HttpStatus.OK);
	 * 
	 * }
	 */
